...
import { CircleAlert, Coins, Flag, Layers3, ReceiptText, Sparkles, WalletCards } from "lucide-react";
...
export function MoneyAllocationPlan({ expectedIncome, budgets, subscriptions, installments, payments, goals }: Props) {
