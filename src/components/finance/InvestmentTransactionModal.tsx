...
import { Investment, type NewInvestmentTransaction } from "@/hooks/useInvestments";
import { Account } from "@/hooks/useAccounts";

interface Props {
  open: boolean;
  onOpenChange: (o: boolean) => void;
  onSubmit: (data: NewInvestmentTransaction) => Promise<void>;
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="space-y-1.5">
            ...
            <Select value={type} onValueChange={(value: "deposit" | "withdraw") => setType(value)}>
